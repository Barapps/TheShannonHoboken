 ...
 */
public class updateNameTask extends AsyncTask <String, Void, String> {
    Context ctx;
    updateNameTask(Context ctx){
        this.ctx = ctx;
    ...
    protected String doInBackground(String... params) {
        String update_url = "http://blue.cs.montclair.edu/~lafontan/TheShannonHoboken/updateName.php";
    ...
    protected void onPostExecute(String result) {
        ...
        if (result.equals("Your name was updated successfully!")) {
